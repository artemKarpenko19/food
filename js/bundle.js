...
function cards () {
  ...
  (0,_services_services__WEBPACK_IMPORTED_MODULE_0__.getResorces)('http://localhost:3000/menu')
  .then(data => {
...
/* harmony export */   "default": () => (__WEBPACK_DEFAULT_EXPORT__)
/* harmony export */ });
function slider ({container, slide, nextArrow, prevArrow, totalAmount, currentCounter, wrapper, field}) {
     // Slider //
  let slideIndex = 1,
  offset = 0;
...
window.addEventListener("DOMContentLoaded", () => {
  ...
  const modalTimer = setTimeout(()=>{(0,_modules_modal__WEBPACK_IMPORTED_MODULE_3__["default"])('.modal', modalTimer);}, 30000);
  ...
  (0,_modules_timer__WEBPACK_IMPORTED_MODULE_6__["default"])('.timer', "2022-12-19");
